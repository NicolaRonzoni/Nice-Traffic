...
km_dba = TimeSeriesKMeans(n_clusters=5, metric="softdtw",metric_params={"gamma": 22.206778280673635}, max_iter=5,max_iter_barycenter=5, random_state=0).fit(multivariate_time_series_train)
...
index_all= pd.date_range('9/2/2019', periods=111, freq='D')

#plot the result train 
events_train = pd.Series(prediction_train,index=index_all)
calplot.calplot(events_train,yearlabel_kws={'color': 'black'}, cmap='cool', suptitle='Clustering of the days train set C094 softDTW', linewidth=2.3)  
new=[]
